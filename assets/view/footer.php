...
body {
    font-family: 'Helvetica', sans-serif; /* Sử dụng font chữ sans-serif mặc định */
    background-color: #f4f4f4; /* Màu nền sáng hơn */
    margin: 0;
    padding: 0;
}
...
ul.list-unstyled li {
    margin-bottom: 15px; /* Tăng khoảng cách giữa các mục */
}
...
.cpy-right {
    margin-top: 30px;
    padding-top: 20px;
    border-top: 1px solid #777; /* Tăng độ sáng của đường kẻ phía trên footer */
    display: flex;
    justify-content: space-between;
    align-items: center;
}
...
.move-top {
    color: #fff;
    font-size: 1.8em; /* Tăng kích thước của nút lên đầu trang */
    text-decoration: none;
}

.move-top:hover {
    color: #ffd700; /* Đổi màu khi di chuột qua */
}
